...
namespace MySQLBlog
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            //Students.ItemsSource = App.STUDENT_VIEW_MODEL.GetStudents();
            //StudentsUpdate.ItemsSource= App.STUDENT_VIEW_MODEL.GetStudents();
            //Todos.ItemsSource = App.TODO_VIEW_MODEL.GetTodos();

        }

        //private void InsertNewStudentBtn_Click(object sender, RoutedEventArgs e)
        //{
        //    for(int i=0;i<100;i++)
        //    {
        //        App.STUDENT_VIEW_MODEL.InsertNewStudent(i, "name" + i, "mark" + i);
        //    }
        //}
    }
}
